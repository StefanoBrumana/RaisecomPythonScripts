#python script version 0.3 December 2020 to telnet multiple Raisecom devices all
#with same username, password and ( optional enable password )
...
print ("#################################")
print ("Python telnet script for Raisecom")
print ("##########FaAndàIMan#############")
...
for line in iplist:
 ...
 try:
  ...
  for line in commands:
   ...
   print (line)
   time.sleep(5)
   #each telnet command is executed every 5 seconds: increase it if some output is missing
